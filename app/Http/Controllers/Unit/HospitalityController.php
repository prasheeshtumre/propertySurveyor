...
class HospitalityController extends Controller
{
    ...
    public function storeHospitalityPropertyDetails(Request $request)
    {
        ...
        $hospitality = SecondaryUnitLevelData::where([['property_id', $request->property_id], ['unit_id', $request->unit_id], ['unit_type_id', $request->unit_type_id], ['unit_cat_id', $request->unit_cat_id], ['property_cat_id', $request->property_cat_id]])->first();
        ...
        $save->rooms = $request->rooms ? $request->rooms : $request->other_rooms_count;
    ...
    public function storeHospitalityPricingDetails(Request $request)
    {
        ...
        if ($hospitality) {
            if ($request->pricing_details_for == 1) {
                ...
                $hospitality->mainteinance = $request->mainteinance;
                $hospitality->maintenance_period = $request->price_period;
                $hospitality->expected_rental = $request->expected_rental;
                $hospitality->booking_amount = $request->booking_amount;
                $hospitality->annual_due_pay = $request->annual_due_pay;
                $hospitality->membership_charge = $request->membership_charge;
                $hospitality->remark = $request->remark;
                $hospitality->sale_status = $request->new_resale_unit;
                $hospitality->sqft_based_on = isset($request->sqft_based_on) ? $request->sqft_based_on : 1;
                ...
                $hospitality->maintenance_rent = $request->maintenance_rent;
                $hospitality->maintenance_period = $request->maintenance_period;
                $hospitality->booking_amount_rent = $request->booking_amount_rent;
                $hospitality->annual_dues_rent = $request->annual_dues_rent;
                $hospitality->membership_charge_rent = $request->membership_charge_rent;
                $hospitality->notice_period = $request->notice_period;
                $hospitality->agreement_duration = $request->agreement_duration;
                $hospitality->remark = $request->remark;
                $hospitality->sqft_based_on = isset($request->sqft_based_on) ? $request->sqft_based_on : 0;
                $hospitality->save();
                ...
                $hospitality->pricing_details_for = $request->pricing_details_for;
                $hospitality->agreement_type = $request->agreement_type;
                $hospitality->expected_rent = $request->rented_price;
                $hospitality->rented_date = $request->rented_date;
                $hospitality->maintenance_rent = $request->maintenance_rent;
                $hospitality->maintenance_period = $request->maintenance_period;
                $hospitality->booking_amount_rent = $request->booking_amount_rent;
                $hospitality->annual_dues_rent = $request->annual_dues_rent;
                ...
                $hospitality->pricing_details_for = $request->pricing_details_for;
                $hospitality->ownership = $request->ownership;
                $hospitality->expected_price = $request->sold_price;
                $hospitality->rented_date = $request->sold_date;
                $hospitality->price_per_sq_ft = $request->price_per_sqft_sold;
                $hospitality->mainteinance = $request->mainteinance;
                $hospitality->maintenance_period = $request->price_period;
                $hospitality->expected_rental = $request->expected_rental;
                $hospitality->booking_amount = $request->booking_amount;
                ...
                $hospitality->remark = $request->remark;
                $hospitality->sale_status = $request->new_resale_unit;
                $hospitality->sqft_based_on = isset($request->sqft_based_on_sold) ? $request->sqft_based_on_sold : 0;
