...
class ProjectStatusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $result['disabled_options'] = $disabled_options;
        $result['message'] = 'Project Status Updated Successfully.';
    ...
    public function project_status_fields(Request $request)
    {
        ...
        $tower_type = $property->residential_type == config('constants.APARTMENT') ? 1 : 2;
