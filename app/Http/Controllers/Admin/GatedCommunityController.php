...
class GatedCommunityController extends Controller
{
    ...
    public function storeServicedApartmentsPricingDetails(Request $request)
    {
        ...
        if ($serviced_apartment) {
            if ($request->pricing_details_for == 1) {
                ...
                saveUnitPriceLog($request->property_id, $request->unit_id, $request->pricing_details_for, $request->expected_price, date('Y-m-d'));
                ...
                updateSaleRent($request->property_id, $request->unit_id, $request->pricing_details_for);
                saveUnitPriceLog($request->property_id, $request->unit_id, $request->pricing_details_for, $request->expected_rent, date('Y-m-d'));
                ...
                updateSaleRent($request->property_id, $request->unit_id, $request->pricing_details_for);
                saveUnitPriceLog($request->property_id, $request->unit_id, $request->pricing_details_for, $request->rented_price, $request->rented_date);
                ...
                updateSaleRent($request->property_id, $request->unit_id, $request->pricing_details_for);
                saveUnitPriceLog($request->property_id, $request->unit_id, $request->pricing_details_for, $request->sold_price, $request->sold_date);
    ...
    public function gatedReport(Request $request, $type = null)
    {
        ...
        if (isset($request->type_of_project) && !empty($request->type_of_project)) {
            ...
            $properties->whereIn('residential_sub_type', [config('constants.GATED_COMMUNITY_APARTMENT'), config('constants.GATED_COMMUNITY_VILLA')]);
            $properties->orWhere('plot_land_type', config('constants.GATED_COMMUNITY_PLOT_LAND'));
        }
