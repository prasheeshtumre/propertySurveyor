                        ...
                        <div class="card  ">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to KONU</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="username" id="email" placeholder="Enter Username">
                                            @error('username')
                                ...
                                <div class="mt-4">
                                    <button class="btn add-property w-100" type="submit">Sign In</button>
                                </div>
