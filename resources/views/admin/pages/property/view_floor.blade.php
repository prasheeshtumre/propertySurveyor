                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne{{ $floor_key }}" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    @if ($floor->units > 0)
                                        @include('admin.pages.property.view_unit', [
                                            'units' => $units,
                                            'floor_Key' => $floor_key,
                                            'floor_id' => $floor->id,
                                        ])
                                            ...
                                            @if ($floor->id == $f_unit->floor_id)
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <a  
                                                        ...
                                                        @endif
                                                        href="{{ url('surveyor/property/unit_details') }}/{{ $f_unit->id }}"
                                                        class="active activeCard {{$property->temp_gis_id_status == 0 || $property->temp_gis_id_status == 2 ? '' : 'gis-engineer-approvall'}}" >

                                                        <div class="card">
                                                            <div class="card-body Unit_MainDetails  {{ in_array($f_unit->id, $unit_detail_ids) ? 'details-found' : 'details-not-found' }}">
