                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mt-3 mb-3">
                                            <div class="col-md-4">
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none" name="plot_area" id="CarpetArea" placeholder="Plot Area " />
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 d-flex align-items-center mt-1">
                                                <input class="form-control " type="text" name="plot_length" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="Length of Plot (in Ft.)">
                                            </div>

                                            <div class="col-md-3 d-flex align-items-center mt-1">
                                                <input class="form-control " type="text" name="plot_breadth" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder=" Breadth of Plot (in Ft.)">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control" name="floors_allowed" type="text" maxlength="11" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="No. of Floors">
                                        </div>
                                        ...
                                        <div class="row align-items-center mb-1">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="openside1" name="no_of_open_side" value="1" checked>
                                                    <label for="openside1">1</label>
                                                    <input type="radio" id="openside2" name="no_of_open_side" value="2">
                                                    <label for="openside2">2</label>
                                                    <input type="radio" id="openside3" name="no_of_open_side" value="3">
                                                    <label for="openside3">3</label>
                                                    <input type="radio" id="openside4" name="no_of_open_side" value="4">
                            ...
                            <div class="screen">
                                ...
                                <div class="card-footer">
                                    <div class="ms-auto text-end">
                                        ...
                                        <button type="submit" class="btn btn-done btn-primary nxt-btn" data-screen="plot-land" id="step3">Submit &nbsp;<i class="fa fa-arrow-right"></i></button>
                                    </div>
                                </div>
                            </div>
...
<script src="{{ url('public/assets/js/property/units/sqftPriceCalculator.js') }}?v=8596"></script>
<script src="{{ url('public/assets/js/property/units/pricing_other_details/addPricingDetails.js') }}?v=41"></script>
...
<script>
    $(document).ready(function() {
        ...
        $('form[id=SubmitUnitImages]').submit(function(e) {
            ...
            // console.log(formData, "formData")
            $.ajax({
                url: "{{ route('surveyor.property.unit_details.plotland.openPlotLand.store_images') }}",
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                ...
                success: function(response) {
                    ...
                    var url =
                        "{{ route('surveyor.property.plot_land.unit_details', [':id']) }}";
