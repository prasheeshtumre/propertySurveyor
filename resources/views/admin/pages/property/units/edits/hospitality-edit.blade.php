...
@section('content')
    ...
    @push('css')
        <link href="{{ asset('assets/css/unit-details.css') }}?v=2380" rel="stylesheet" type="text/css" />
    @endpush
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit {{ $unit_data->categoryName->title }} Details</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <div id="screens">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    ...
                                                    <div class="extra-bedrooms-block" style="display: none;">
                                                        <input type="radio" id="extra-bedrooms-input" name="rooms"
                                                            value="">
                                            ...
                                            <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                                <input type="text" class="form-control col-md-3"
                                                    placeholder="Enter rooms" maxlength="3"
                                                    oninput="validateNumericInput(event)"
                                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                    name="other_rooms_count" id="other-bedrooms">
                                            </div>
                                ...
                                <form name="AmenitiesForm" method="POST">
                                    ...
                                    <div class="screen ">
                                        <div class="card1">
                                            <div class="row mt-3 mb-3">
                                                @include('admin.pages.property.units.includes.property_information')Address : </b> <span
                                                    class="project-head">{{ $property->street_details }}</span></p>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="mt-4 mb-4">
        ...
        $(document).ready(function() {
            ...
            $('.add-extra-bedrooms').click(function() {
                ...
                if (addinVal != "" && addinVal > 4) {
                    ...
                    $('input[type="radio"][name=rooms][value="' + addinVal + '"]').prop('checked', true);
                    $('.other-bedrooms-block').hide();
                    $('.add-extra-bedrooms').hide();
                }
                    ...
                    error: function(jqXHR, textStatus, errorThrown) {
                        ...
                        if (jqXHR.status == 422) {
                            for (const [key, value] of Object.entries(jqXHR.responseJSON
                                ...
                                if (key == 'rooms' || key == 'washrooms' || key ==
            ...
            let pricingUrl =
                "{{ route('surveyor.property.unit_details.commercial.hospitality.store_pricing_details') }}";
            ...
            $('form[id=SubmitUnitImages]').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('surveyor.property.unit_details.commercial.hospitality.update_unit_images') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
