            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit One Rk Details </h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 mb-4">
                            <div id="screens">
                                    ...
                                    <div class="screen visible">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="bedrooms1" name="bedrooms" value="1"
                                                        @if ($onerkdata->rooms == 1) checked @endif>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="washrooms1" name="washrooms" value="1"
                                                        @if ($onerkdata->washrooms == 1) checked @endif>
                                        ...
                                        <div class="radio-toolbar-text">
                                            @foreach ($property_facings as $facing)
                                                <input type="radio" id="property_facing{{ $facing->id }}"
                                                    @if ($onerkdata->property_facing == $facing->id) checked @endif name="property_facing"
                                                    value="{{ $facing->id }}">
                                                <label
                                        ...
                                        <div class="row align-items-center mt-3 mb-3 area-details-block">
                                                            ...
                                                            <select class="form-select form-control-b0 border-left"
                                                                ...
                                                                @foreach ($area_detail_units as $area_units)
                                                                    <option value="{{ $area_units->id }}"
                                                                        @if ($onerkdata->carpet_area_unit == $area_units->id) selected @endif>
                                            ...
                                            <div class="col-md-4 built-area-block"
                                                @if ($onerkdata->buildup_area == null) style="display: none;" @endif>
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11"
                                                        ...
                                                        <div class="ms-auto" style="">
                                                            <select class="form-select form-control-b0"
                                                                ...
                                                                @foreach ($area_detail_units as $area_units)
                                                                    <option value="{{ $area_units->id }}"
                                                                        @if ($onerkdata->buildup_area_unit == $area_units->id) selected @endif>
                                                                        {{ $area_units->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="col-md-4 super-built-area-block"
                                                @if ($onerkdata->super_buildup_area == null) style="display: none;" @endif>
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11"
                                                                ...
                                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                class="form-control form-control-b0 col-md-3 border-none required-text"
                                                                value="{{ $onerkdata->super_buildup_area ?? '' }}"
                                                        ...
                                                        <div class="ms-auto" style="">
                                                            <select class="form-select form-control-b0"
                                                                ...
                                                                @foreach ($area_detail_units as $area_units)
                                                                    <option value="{{ $area_units->id }}"
                                                                        @if ($onerkdata->super_buildup_area_unit == $area_units->id) selected @endif>
                                                                        {{ $area_units->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                            ...
                                            @foreach ($furnished_options as $furnish)
                                                <div>
                                                    <input type="radio" id="furnished-option{{ $furnish->id }}"
                                                        ...
                                                        @if ($furnish->id == $onerkdata->furnishing_option) checked @endif
                                                        value="{{ $furnish->id }}">
                                                ...
                                                <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="input-step step-primary float-left mr-2">
                                                        ...
                                                        <input type="number" class="product-quantity"
                                                            value="{{ $onerkdata->covered_parking ?? '1' }}"
                                                            name="covered_parking" min="1" max="100"
                                                            readonly="">
                                            ...
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="input-step step-primary float-left mr-2">
                                                        <button type="button" class="minus">–</button>
                                                        <input type="number" class="product-quantity"
                                                            value="{{ $onerkdata->open_parking ?? '1' }}"
                                                            name="open_parking" min="1" max="100"
                                                            readonly="">
                                                        <button type="button" class="plus">+</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="radio-toolbar-text">
                                            @foreach ($availability_status as $availability)
                                                <input type="radio" class="availability_status_radio"
                                                    ...
                                                    @if ($availability->id == $onerkdata->availability_status) checked @endif
                                        ...
                                        <div class="possession-block"
                                            @if ($onerkdata->availability_status != 24) style="display: none;" @endif>
                                            <label class="form-label m-0 required">Possesion by</label>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <input type="date" class="form-control"
                                                        value="{{ \Carbon\Carbon::parse($onerkdata->possesion_by)->format('Y-m-d') }}"
                               ...
                               @include('admin.pages.property.units.edits.includes.add_images')                                <!-- scrren4 -->
                                                                ...
                                                                <select class="form-select" name="floor_type">
                                                                    ...
                                                                    @forelse($flooring_type as $unit)
                                                                        <option value="{{ $unit->id }}"
                                                                            @if ($onerkdata->floor_type == $unit->id) selected @endif>
                                                                            {{ $unit->name }}</option>
                                                                    @empty
                                                                    @endforelse
                                                                </select>
                                                            ...
                                                            <div class="d-flex">
                                                                <div>
                                                                    <input type="text" maxlength="11"
                                                                        ...
                                                                        value="{{ $onerkdata->facing_road_width ?? '' }}"
                                                                ...
                                                                <div class="ms-auto" style="">
                                                                    <select class="form-select form-control-b0"
                                                                        ...
                                                                        @forelse($width_facing_road_units as $unit)
                                                                            <option value="{{ $unit->id }}"
                                                                                @if ($onerkdata->facing_road_width_unit == $unit->id) selected @endif>
                                                                                {{ $unit->name }}</option>
                                                                        @empty
                                                                        @endforelse
                                                                    </select>
...
@push('scripts')
    ...
    <script src="{{ url('public/assets/js/property/units/sqftPriceCalculator.js') }}?v=8"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // second form submit
            let pricingUrl =
                "{{ route('surveyor.property.unit_details.resedential.one_rk.store_pricing_details') }}";
