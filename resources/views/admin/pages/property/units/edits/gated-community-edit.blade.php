                ...
                <div class="col-12">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        @if (
                            ...
                            <h4 class="mb-sm-0"> Edit Apartment Details(gated)</h4>
                        @elseif(
                            $property->cat_id == config('constants.RESIDENTIAL') &&
                            ...
                            <h4 class="mb-sm-0">Edit Villa Details(gated)</h4>
                        @elseif(
                            $property->cat_id == config('constants.PLOT_LAND') &&
                                $property->plot_land_type == config('constants.GATED_COMMUNITY_PLOT_LAND'))
                            <h4 class="mb-sm-0">Edit Plot Land Villa Details(gated)</h4>
                        @else
                            <h4 class="mb-sm-0">Edit Stand-Alone Apartment Details</h4>
                        @endif
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="screen visible">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="bedrooms1" name="bedrooms" value="1"
                                                        @if ($secondary_level_unit_data->rooms == 1) checked @endif>
                                                    <label for="bedrooms1">1</label>
                                                    <input type="radio" id="bedrooms2" name="bedrooms" value="2"
                                                        @if ($secondary_level_unit_data->rooms == 2) checked @endif>
                                                    <label for="bedrooms2">2</label>
                                                    <input type="radio" id="bedrooms3" name="bedrooms" value="3"
                                                        @if ($secondary_level_unit_data->rooms == 3) checked @endif>
                                                    <label for="bedrooms3">3</label>
                                                    <input type="radio" id="bedrooms4" name="bedrooms" value="4"
                                                        @if ($secondary_level_unit_data->rooms == 4) checked @endif>
                                                    <label for="bedrooms4">4</label>
                                                    @if ($secondary_level_unit_data->rooms > 4)
                                                        <input type="radio" id="bedrooms5" name="bedrooms"
                                                            value="{{ $secondary_level_unit_data->rooms }}" checked>
                                                        <label
                                                            for="bedrooms5">{{ $secondary_level_unit_data->rooms }}</label>
                                                    @endif
                                            ...
                                            <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                                <input type="text" maxlength="3" class="form-control col-md-3"
                                                    placeholder="Enter bedrooms" oninput="validateNumericInput(event)"
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="washrooms1" name="washrooms"
                                                        value="1" @if ($secondary_level_unit_data->washrooms == 1) checked @endif>
                                                    <label for="washrooms1">1</label>
                                                    <input type="radio" id="washrooms2" name="washrooms"
                                                        value="2" @if ($secondary_level_unit_data->washrooms == 2) checked @endif>
                                                    <label for="washrooms2">2</label>
                                                    <input type="radio" id="washrooms3" name="washrooms"
                                                        value="3" @if ($secondary_level_unit_data->washrooms == 3) checked @endif>
                                                    <label for="washrooms3">3</label>
                                                    <input type="radio" id="washrooms4" name="washrooms"
                                                        value="4" @if ($secondary_level_unit_data->washrooms == 4) checked @endif>
                                                    <label for="washrooms4">4</label>
                                                    @if ($secondary_level_unit_data->washrooms > 4)
                                                        <input type="radio" id="washrooms5" name="washrooms"
                                                            value="{{ $secondary_level_unit_data->washrooms }}" checked>
                                                        <label
                                                            for="washrooms5">{{ $secondary_level_unit_data->washrooms }}</label>
                                                    @endif
                                            ...
                                            <div class="col-md-2 other-washrooms-block" style="display: none;">
                                                <input type="text" maxlength="3" class="form-control col-md-3"
                                                    placeholder="Enter washrooms" oninput="validateNumericInput(event)"
                                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                        ...
                                        <div class="radio-toolbar-text">
                                            @foreach ($property_facings as $facing)
                                                <input type="radio" id="property_facing{{ $facing->id }}"
                                                    ...
                                                    @if ($secondary_level_unit_data->property_facing == $facing->id) checked @endif
                                                    value="{{ $facing->id }}">
                                                <label
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="balcony1" name="balconies" value="1"
                                                        @if ($secondary_level_unit_data->balconies == 1) checked @endif>
                                                    <label for="balcony1">1</label>
                                                    <input type="radio" id="balcony2" name="balconies" value="2"
                                                        @if ($secondary_level_unit_data->balconies == 2) checked @endif>
                                                    <label for="balcony2">2</label>
                                                    <input type="radio" id="balcony3" name="balconies" value="3"
                                                        @if ($secondary_level_unit_data->balconies == 3) checked @endif>
                                                    <label for="balcony3">3</label>
                                                    <input type="radio" id="balcony4" name="balconies" value="4"
                                                        @if ($secondary_level_unit_data->balconies == 4) checked @endif>
                                                    <label for="balcony4">4</label>
                                                    @if ($secondary_level_unit_data->balconies > 4)
                                                        <input type="radio" id="balcony4" name="balconies"
                                                            value="{{ $secondary_level_unit_data->balconies }}" checked>
                                                        <label
                                                            for="balcony4">{{ $secondary_level_unit_data->balconies }}</label>
                                                    @endif
                                        ...
                                        <div class="row align-items-center mt-3 mb-3 area-details-block">
                                                    ...
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11"
                                                                ...
                                                                value="{{ $secondary_level_unit_data->carpet_area ?? '' }}"
                                                            ...
                                                            <select class="form-select form-control-b0 border-left"
                                                                ...
                                                                @foreach ($area_detail_units as $area_units)
                                                                    <option value="{{ $area_units->id }}"
                                                                        @if ($secondary_level_unit_data->carpet_area_unit == $area_units->id) selected @endif>
                                                                        {{ $area_units->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="clearfix mb-3"></div>
                                            <div class="col-md-4 built-area-block"
                                                @if ($secondary_level_unit_data->buildup_area == null) style="display: none;" @endif>
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11"
                                                                ...
                                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                class="form-control form-control-b0 col-md-3 border-none required-text"
                                                                value="{{ $secondary_level_unit_data->buildup_area ?? '' }}"
                                                        ...
                                                        <div class="ms-auto" style="">
                                                            <select class="form-select form-control-b0"
                                                                ...
                                                                @foreach ($area_detail_units as $area_units)
                                                                    <option value="{{ $area_units->id }}"
                                                                        @if ($secondary_level_unit_data->buildup_area_unit == $area_units->id) selected @endif>
                                                                        {{ $area_units->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="clearfix mb-3"></div>
                                            <div class="col-md-4 super-built-area-block"
                                                @if ($secondary_level_unit_data->super_buildup_area == null) style="display: none;" @endif>
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11"
                                                                ...
                                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                class="form-control form-control-b0 col-md-3 border-none required-text"
                                                                value="{{ $secondary_level_unit_data->super_buildup_area ?? '' }}"
                                                        ...
                                                        <div class="ms-auto" style="">
                                                            <select class="form-select form-control-b0"
                                                                ...
                                                                @foreach ($area_detail_units as $area_units)
                                                                    <option value="{{ $area_units->id }}"
                                                                        @if ($secondary_level_unit_data->super_buildup_area_unit == $area_units->id) selected @endif>
                                                                        {{ $area_units->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            @foreach ($other_rooms as $room)
                                                <div class="col-md-2 simplecheck mb-3">
                                                    <span><input type="checkbox" name="other_rooms[]"
                                                            @if (in_array($room->id, $other_room_values)) checked @endif
                                            ...
                                            @foreach ($furnished_options as $furnish)
                                                <div>
                                                    <input type="radio" id="furnished-option{{ $furnish->id }}"
                                                        name="furnished_option"
                                                        @if ($furnish->id == $secondary_level_unit_data->furnishing_option) checked @endif
                                                        value="{{ $furnish->id }}">
                                                                        ...
                                                                        <div class="col-md-4  col-6 mb-3">
                                                                            <span>
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    @if (isset($chechkOptions[$option->id])) @if ($option->id == $chechkOptions[$option->id]) checked @endif
                                                                                    @endif
                                                                                name="{{ str_replace([' ', '-'], '_', $furnish->name) }}_{{ str_replace([' ', '-'], '_', $option->name) }}"/>
                                                                                {{ $option->name }}
                                                                            </span>
                                                ...
                                                <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="input-step step-primary float-left mr-2">
                                                        ...
                                                        <input type="number" class="product-quantity"
                                                            value="{{ $secondary_level_unit_data->covered_parking ?? '1' }}"
                                            ...
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="input-step step-primary float-left mr-2">
                                                        <button type="button" class="minus">–</button>
                                                        <input type="number" class="product-quantity"
                                                            value="{{ $secondary_level_unit_data->open_parking ?? '1' }}"
                                        ...
                                        <div class="radio-toolbar-text">
                                            @foreach ($availability_status as $availability)
                                                <input type="radio" class="availability_status_radio"
                                                    ...
                                                    @if ($availability->id == $secondary_level_unit_data->availability_status) checked @endif
                                        ...
                                        <div class="clearfix mb-3"></div>
                                        <div class="age-of-property-block"
                                            @if ($secondary_level_unit_data->availability_status != 23) style="display: none;" @endif>
                                            ...
                                            <div class="radio-toolbar-text">
                                                @foreach ($age_props as $prop)
                                                    <input type="radio" id="age_prop{{ $prop->id }}"
                                                        ...
                                                        @if ($secondary_level_unit_data->age_of_property == $prop->id) checked @endif
                                                        value="{{ $prop->id }}">
                                        ...
                                        <div class="possession-block"
                                            @if ($secondary_level_unit_data->availability_status != 24) style="display: none;" @endif>
                                            <label class="form-label m-0 required">Possesion by</label>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <input type="date" class="form-control"
                                                        value="{{ \Carbon\Carbon::parse($secondary_level_unit_data->possesion_by)->format('Y-m-d') }}"
                                                            ...
                                                            <div class="col-md-2 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="amenity[]"
                                                                        value="{{ $amenity->id }}"
                                                                        @if (in_array($amenity->id, $amenities_values)) checked @endif>
                                                                    {{ $amenity->name }}
                                                                </span>
                                                            </div>
                                                        @empty
                                                            ...
                                                            <div class="col-md-3 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="society_features[]"
                                                                        ...
                                                                        @if (in_array($loc_advantage->id, $Society_features_values)) checked @endif>
                                                                    {{ $loc_advantage->name }}
                                                                </span>
                                                            </div>
                                                        @empty
                                                            ...
                                                            <div class="col-md-3 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="additional_features[]"
                                                                        value="{{ $loc_advantage->id }}"
                                                                        @if (in_array($loc_advantage->id, $additional_values)) checked @endif>
                                                                    {{ $loc_advantage->name }}
                                                                </span>
                                                            </div>
                                                        @empty
                                                            ...
                                                            <div class="col-md-3 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="other_features[]"
                                                                        value="{{ $loc_advantage->id }}"
                                                                        @if (in_array($loc_advantage->id, $other_values)) checked @endif>
                                                                    {{ $loc_advantage->name }}
                                                                </span>
                                                            </div>
                                                        @empty
                                                            ...
                                                            <div class="col-md-3 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="water_source[]"
                                                                        value="{{ $loc_advantage->id }}"
                                                                        @if (in_array($loc_advantage->id, $water_values)) checked @endif>
                                                                    {{ $loc_advantage->name }}
                                                                </span>
                                                            </div>
                                                        @empty
                                                            ...
                                                            <div class="col-md-3 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="overlooking[]"
                                                                        value="{{ $loc_advantage->id }}"
                                                                        @if (in_array($loc_advantage->id, $overlooking_values)) checked @endif>
                                                                    {{ $loc_advantage->name }}
                                                                </span>
                                                            </div>
                                                        @empty
                                                            ...
                                                            <div class="col-md-3 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="power_backup[]"
                                                                        value="{{ $loc_advantage->id }}"
                                                                        @if (in_array($loc_advantage->id, $powerbackup_values)) checked @endif>
                                                                    {{ $loc_advantage->name }}
                                                                </span>
                                                            </div>
                                                        @empty
                                                                ...
                                                                <select class="form-select" name="floor_type">
                                                                    ...
                                                                    @forelse($flooring_type as $unit)
                                                                        <option value="{{ $unit->id }}"
                                                                            @if ($secondary_level_unit_data->floor_type == $unit->id) selected @endif>
                                                                            {{ $unit->name }}
                                                                        </option>
                                                                    @empty
                                                                    @endforelse
                                                            ...
                                                            <div class="d-flex">
                                                                <div>
                                                                    <input type="text" maxlength="11"
                                                                        ...
                                                                        value="{{ $secondary_level_unit_data->facing_road_width ?? '' }}"
                                                                ...
                                                                <div class="ms-auto" style="">
                                                                    <select class="form-select form-control-b0"
                                                                        ...
                                                                        @forelse($width_facing_road_units as $unit)
                                                                            <option value="{{ $unit->id }}"
                                                                                @if ($secondary_level_unit_data->facing_road_width_unit == $unit->id) selected @endif>
                                                                                {{ $unit->name }}
                                                                            </option>
                                                                        @empty
                                                                        @endforelse
                                                            ...
                                                            <div class="col-md-3 simplecheck mb-3">
                                                                <span>
                                                                    <input type="checkbox" name="location_advantage[]"
                                                                        value="{{ $loc_advantage->id }}"
                                                                        @if (in_array($loc_advantage->id, $location_advantages_values)) checked @endif>
                                                                    {{ $loc_advantage->name }}
                                                                </span>
                                                            </div>
                                                        @empty
...
@push('scripts')
    ...
    <script src="{{ url('public/assets/js/image-compression-helper.js') }}?v=4545"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('form[id=SubmitPropertyDetails]').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('surveyor.property.unit_details.resedential.gated_community.store_property_details') }}",
                    type: 'POST',
                    headers: {
            ...
            let pricingUrl =
                "{{ route('surveyor.property.unit_details.resedential.gated_community.store_pricing_details') }}";
            ...
            $('form[id=SubmitUnitImages]').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('surveyor.property.unit_details.resedential.gated_community.edit_unit_images') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            $('form[name=AmenitiesForm]').submit(function(e) {
                ...
                // console.log(formData, "formData")
                $.ajax({
                    url: "{{ route('surveyor.property.unit_details.resedential.gated_community.store_amenities') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    ...
                    success: function(response) {
                        ...
                        var url =
                            "{{ route('surveyor.property.unit_details', [':id', $sub_type]) }}";
