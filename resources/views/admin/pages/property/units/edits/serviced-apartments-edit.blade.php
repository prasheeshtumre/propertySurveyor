            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        @if ($property->cat_id == 2 && $property->residential_type == 7 && $property->residential_sub_type == 10)
                            <h4 class="mb-sm-0"> Ediit Apartment Details</h4>
                        @elseif($property->cat_id == 2 && $property->residential_type == 8 && $property->residential_sub_type == 12)
                            <h4 class="mb-sm-0">Edit Villa Details</h4>
                        @elseif(
                            ...
                            <h4 class="mb-sm-0">Edit Individual House Details</h4>
                        @elseif(
                            $property->cat_id == config('constants.RESIDENTIAL') &&
                            ...
                            <h4 class="mb-sm-0">Edit Serviced Apartments Details</h4>
                        @else
...
@push('scripts')
    ...
    <script src="{{ url('public/assets/js/property/units/sqftPriceCalculator.js') }}?v=522"></script>
    <script src="{{ url('public/assets/js/property/units/pricing_other_details/editPricingDetails.js') }}?v=2"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('form[id=SubmitUnitImages]').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('surveyor.property.unit_details.resedential.serviced_apartments.edit_unit_images') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
