                            ...
                            <div id="screens">
                                ...
                                <form id="SubmitPropertyDetails" method="post">
                                    ...
                                    <div class=" screen visible">
                                        ...
                                        <label class=" form-label ">Add Area Details <span class="text-danger"> *</span>
                                        </label>
                                        ...
                                        <label class="form-label ">Property Facing <span class="text-danger">
                                                *</span></label>
                                        <div class="row align-items-center mb-3">
                                                ...
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text"
                                                                class="form-control form-control-b0 col-md-3 border-none"
                                                                onkeypress="return isNumber(event)" name="enterance_width"
                                                                id="" placeholder="Entrance Width">
                                                        </div>
                                                        <div class="ms-auto" style=" ">
                                                            <select class="form-select form-control-b0"
                                                ...
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text"
                                                                class="form-control form-control-b0 col-md-3 border-none"
                                                                onkeypress="return isNumber(event)" name="ceiling_height"
                                                                id="" placeholder="Ceiling Height">
                                                        </div>
                                                        <div class="ms-auto" style=" ">
                                                            <select class="form-select form-control-b0"
                                                ...
                                                <div class=" row justify-content-start" id="WashRooms"
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        <input type="text" class="form-control"
                                                            name="priavate_washrooms" id=""
                                                            placeholder="No. of Private Washrooms" />
                                                    </div>
                                                    <div class="col-md-3 mt-3">
                                                        <input type="text" class="form-control"
                                                            name="shared_washrooms" id=""
                                                ...
                                                <div class="radio-toolbar-text">
                                                    @forelse($located_near as $located)
                                                        <input type="radio" id="located-{{ $located->id }}"
                                                            name="located_near" value="{{ $located->id }}">
                                                        <label
                                        ...
                                        <label class="form-label ">Parking Type <span class="text-danger">
                                                *</span></label>
                                        <div class="row align-items-center mb-2">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar-text">
                                                    @forelse($parking_types as $p_type)
                                                        <input type="radio" id="parking-type-{{ $p_type->id }}"
                                                            name="parking_type" value="{{ $p_type->id }}">
                                                        <label
                                        ...
                                        <label class="form-label ">Availability Status <span class="text-danger">
                                                *</span></label>
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar-text">
