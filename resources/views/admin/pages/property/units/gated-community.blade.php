...
@push('scripts')
    ...
    <script src="{{ url('public/assets/js/property/units/sqftPriceCalculator.js') }}?v=741859"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('form[id=AddImage]').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('surveyor.property.unit_details.resedential.gated_community.store_unit_images') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
