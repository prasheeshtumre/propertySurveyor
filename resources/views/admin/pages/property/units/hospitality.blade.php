                                    ...
                                    <div class="screen visible">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            ...
                                            <div class="col-md-2 add-balconies">
                                                <a style="color: var(--vz-link-color);"> + Add others</a>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                    <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="input-step step-primary float-left mr-2">
                                                            ...
                                                            <input type="number" class="product-quantity" value="1" name="covered_parking" min="0" maxlength="100" readonly="">
                                            ...
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="input-step step-primary float-left mr-2">
                                                        <button type="button" class="minus">–</button>
                                                        <input type="number" class="product-quantity" value="1" name="open_parking" min="0" maxlength="100" readonly="">
                                                        <button type="button" class="plus">+</button>
                                                    </div>
                                                </div>
