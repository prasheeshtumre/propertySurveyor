            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <div class="row align-items-center mb-2 d-none" id="newResaleUnit">
                        <div class="col-md-12 mb-3">
                            <div class="radio-toolbar-text ">
                                <input type="radio" id="NewUnit" name="new_resale_unit" value="1">
                                <label for="NewUnit">New</label>
                                <input type="radio" id="ResaleUnit" name="new_resale_unit" value="2">
                    ...
                    <div class="row align-items-center mb-3" id="PriceDetailsClone" style="display:none">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="expected_price" oninput="validateNumericInput(event)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="expected_price" placeholder="Expected Price" maxlength="11">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="px-0 col-md-3">
                                    <select class="form-select sqft__based-on" aria-label="Default select example" name="sqft_based_on">
                                        ...
                                        <option value="2">Build-up Area</option>
                                        <option value="3">Super Build-up Area</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-3 simplecheck mb-3">
                            <span><input type="checkbox" name="price_details[]" value="{{ $price_detail->id }}">
                                {{ $price_detail->name }}</span>
                        </div>
                        @empty
                        @endforelse
                    ...
                    <div class="row" id="AdditionalPrcingDetailsClone" style="display:none">
                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col-md-5 ms-auto" style="">
                                        <select class="form-select form-control-b0" name="price_period">
                                            ...
                                            <option value="{{ $price_period->id }}">{{ $price_period->name }}
                                            </option>
                                            @empty
                                            @endforelse
                                        </select>
                        ...
                        <div class="col-md-4 mb-2">
                            <input type="text" class="form-control border-none rent__amount" onkeypress="return isNumber(event)" name="expected_rental" id="" placeholder="Expected Rental">
                    ...
                    <div class="row align-items-center mb-3" id="RentDetailsClone" style="display:none">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control rent__amount" id="" onkeypress="return isNumber(event)" name="expected_rent" placeholder="Expected Rent" maxlength="11">
                            <p class="rent__amount-in__words">
                                <span class=""></span>
                            </p>
                        </div>
                        ...
                        <div class="col-md-4 simplecheck mb-3">
                            <span><input type="checkbox" name="facility[]" value="{{ $facility->id }}">
                                {{ $facility->name }}</span>
                        </div>
                        @empty
                        @endforelse
