	...
	<div class="col-xxl-3 col-md-3 mt-3 append-floors">
		<div>
			...
			<div class="input-group mb-3">
				<input type="text" class="form-control no_of_floors is-numeric ctfd-required" value="{{$property->no_of_floors ?? ''}}" name="no_of_floors" placeholder="Enter No of Floors" aria-label="" aria-describedby="button-addon2">
