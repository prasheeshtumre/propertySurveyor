...
<div class="col-xxl-3 col-md-3 mt-3">
    <div>
        <a class="btn btn-outline-success" href="{{ route('commercial-tower.ct-details', $property->id) }}">
            <div class="d-flex justify-content-center align-items-center">
                <span class="mdi mdi-chevron-double-right mdi-18px"></span>
                <span class="text-dark"> View Commercial Tower Details</span>
            </div>
        </a>
    </div>
</div>
