            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Gated Community Details</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/property/gated/rera-hmda-image-compression-helper.js') }}?v=7555544g"></script>
    ...
    <script>
        ...
        $(document).on('click', '.edit-price-trends', function() {
            ...
            if (towerId == '0') {
                ...
                $("#pt_project_radio").removeClass('d-none');
                $("#pt_tower_radio").addClass('d-none');
                ...
                $("#pt_tower_radio").removeClass('d-none');
                $("#pt_project_radio").addClass('d-none');
