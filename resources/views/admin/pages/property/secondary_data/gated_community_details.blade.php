...
@push('css')
<link href="{{ asset('assets/css/view-gated-community-details.css') }}?v=9638" rel="stylesheet" type="text/css" />
@endpush
@section('content')
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12">
                ...
                <div class="card" style="">
                                ...
                                <div class="row ">
                                    <div class="keyDetailsList col-md-6">
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <span class="w-md-50">Construction Partner</span><strong class="px-1 atp-title--seperator">:</strong>
                                            ...
                                            <li class="list-group-item">
                                                <span class="w-md-50">City</span><strong class="px-1 atp-title--seperator">:</strong>
                                                {{ $city->pincode->pincodeCity->city->name ?? 'N/A' }}
                                            </li>
                                            <li class="list-group-item">
                                                <span class="w-md-50">Pincode</span><strong class="px-1 atp-title--seperator">:</strong>
                                                {{ $property->propertyPincode->pincode_id ?? 'N/A' }}
                                            </li>
                                            <li class="list-group-item">
                                                <span class="w-md-50">Builder / Builder Sub Groups</span><strong class="px-1 atp-title--seperator">:</strong>
                                    ...
                                    <div class="keyDetailsList col-md-6">
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <span class="w-md-50">Area</span><strong class="px-1 atp-title--seperator">:</strong>
                                            ...
                                            <li class="list-group-item">
                                                <span class="w-md-50">No of Units</span>
                                                <strong class="px-1 atp-title--seperator">:</strong>
                                                {{ $property->no_of_units ?? 'N/A' }}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <h2 class="h4 inline-block heading-medium">Blocks / Floors details for
                            {{ $property->project_name ?? '' }}
                        </h2>

                        <div class="property-group-title property-group-block-tower-title ">Blocks</div>
                        ...
                        <div class="property-group-title property-group-block-tower-title">
                        ...
                        <div class="keyDetailsList row">
                            ...
                            <div class="card">
                                <p class="tower-title card-header">{{ $block->block_name }}</p>
                                <ul class=" ul-group block-unit-group card-body">
                                    <li class="block-items my-3 card-body clearfix">
                                        ...
                                        <div class="block-unit-item">{{ $tower->tower_name }}
                                        </div>
                                        @else
                                        <div class="block-unit"> <a target="_blank" href="{{ route('surveyor.property.unit_details', [$tower->id, $sub_type]) }}">{{ $tower->tower_name }}</a>
                                        </div>
                                        @endif
                                        @empty
                                        @endforelse
                            ...
                            <ul class="block-items clearfix">
                                ...
                                @else
                                <li> <a target="_blank" href="{{ route('surveyor.property.unit_details', [$tower->id, $sub_type]) }}">{{ $tower->tower_name }}</a>
                                </li>
                                @endif
                    ...
                    <div class="col-sm-12 col-md-12">
                        <h2 class="h4 inline-block heading-medium">{{ $property->project_name ?? '' }} Amenities
                        </h2>
                        <div class="keyDetailsList row">
                            ...
                            <ul class="col-md-6 ul-group">
                                ...
                                <li class="row ">
                                    ...
                                    <div class="col-md-6 "><span class="mdi mdi-circle-small mdi-18px px-1"></span>{{ $option->name ?? '' }}
                                    </div>
                                    @endif
                                    @empty
                                    @endforelse
                    ...
                    <div class="col-sm-12 col-md-12 ">
                        <h2 class="h4 inline-block heading-medium ">Compliances for
                            {{ $property->project_name ?? '' }}
                        </h2>
                        <div class="row">
                            @include(
                    ...
                    <div class="col-sm-12 col-md-12">
                        <h2 class="h4 inline-block heading-medium">Repositories for
                            {{ $property->project_name ?? '' }}
                        </h2>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <h2 class="h4 inline-block heading-medium"> {{ $property->project_name ?? '' }} Price
                            Trends</h2>
                        @include(
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a class="btn btn-outline-success edit-modal-btn" href="{{ url('surveyor/property/gated-community-details/edit/' . $property->id) }}" previewlistener="true">
