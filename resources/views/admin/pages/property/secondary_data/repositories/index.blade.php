                ...
                <div class="d-flex justify-content-center flex-column ">
                    <form class="unit-gallery-zone icm-zone">
                        ...
                        <input type="file" id="project_brochure_file" class="files img-upload" multiple
                            style="display: none;"
                            data-action="{{ url('surveyor/property/gated-community-details/repository/brochure-files') }}">
                        <div>
                ...
                @forelse($project_repository_files['brochure'] as $file)
                    ...
                    @else
                        <div class="card " style="width: 18rem;">
                            <video controls data-fancybox="project-brochure">
                ...
                <div class="d-flex justify-content-center flex-column ">
                    <form class="unit-gallery-zone icm-zone">
                        ...
                        <input type="file" id="project_promotional_video" class="files img-upload" multiple
                            style="display: none;"
                            data-action="{{ url('surveyor/property/gated-community-details/repository/promotional-video-files') }}">
                        <div>
                            @include('admin.pages.property.secondary_data.repositories.includes.property_info')
                        </div>
                        <div class="row old-files-icm-lable-preview-group">
        ...
        <div class="col-xxl-12 col-md-12">
            @if (isset($project_repository_files['video_files']))
                @forelse($project_repository_files['video_files'] as $file)
                    ...
                    @endphp
                    @if (in_array(strtolower($extension), ['pdf', 'jpg', 'jpeg', 'png', 'gif'], true))
                        <a data-fancybox="project-promotional-video" href="{{ $file }}" class="">
                            <span>
                                <img src="{{ $file }}" class="rounded-circle border border-light border-4"
                                    width="80" height="80"
                                    onerror="this.onerror=null; this.src='{{ $default_pdf_icon }}'">
                    ...
                    @else
                        <div class="card " style="width: 18rem;">
                            <video controls data-fancybox="project-promotional-video">
                                <source src="{{ asset($file) }}" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                ...
                <div class="d-flex justify-content-center flex-column ">
                    <form class="unit-gallery-zone icm-zone">
                        ...
                        <input type="file" id="image_files" class="files img-upload" multiple style="display: none;"
                            data-action="{{ url('surveyor/property/gated-community-details/repository/image-files') }}">
                        <div>
                            @include('admin.pages.property.secondary_data.repositories.includes.property_info')
                        </div>
                        <div class="row old-files-icm-lable-preview-group">
        ...
        <div class="col-xxl-12 col-md-12">
            @if (isset($project_repository_files['image_files']))
                @forelse($project_repository_files['image_files'] as $file)
                    ...
                    @endphp
                    @if (in_array(strtolower($extension), ['pdf', 'jpg', 'jpeg', 'png', 'gif'], true))
                        <a data-fancybox="image-gallery" href="{{ $file }}" class="">
                            <span>
                                <img src="{{ $file }}" class="rounded-circle border border-light border-4"
                                    width="80" height="80"
                                    onerror="this.onerror=null; this.src='{{ $default_pdf_icon }}'">
                    ...
                    @else
                        <div class="card " style="width: 18rem;">
                            <video controls data-fancybox="image-gallery">
                                <source src="{{ asset($file) }}" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                ...
                <div class="d-flex justify-content-center flex-column ">
                    <form class="unit-gallery-zone icm-zone">
                        ...
                        <input type="file" id="view_video_files" class="files img-upload" multiple
                            style="display: none;"
                            data-action="{{ url('surveyor/property/gated-community-details/repository/view-video-files') }}">
                        <div>
                            @include('admin.pages.property.secondary_data.repositories.includes.property_info')
                        </div>
                        <div class="row old-files-icm-lable-preview-group">
        ...
        <div class="col-xxl-12 col-md-12">
            @if (isset($project_repository_files['3dvideo_files']))
                @forelse($project_repository_files['3dvideo_files'] as $file)
                    ...
                    @endphp
                    @if (in_array(strtolower($extension), ['pdf', 'jpg', 'jpeg', 'png', 'gif'], true))
                        <a data-fancybox="three-d-gallery" href="{{ $file }}" class="">
                            <span>
                                <img src="{{ $file }}" class="rounded-circle border border-light border-4"
                                    width="80" height="80"
                                    onerror="this.onerror=null; this.src='{{ $default_pdf_icon }}'">
                    ...
                    @else
                        <div class="card " style="width: 18rem;">
                            <video controls data-fancybox="three-d-gallery">
                                <source src="{{ asset($file) }}" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                ...
                <div class="d-flex justify-content-center flex-column ">
                    <form class="unit-gallery-zone icm-zone">
                        ...
                        <input type="file" id="all_floor_plan_file" class="files img-upload" multiple
                            style="display: none;"
                            data-action="{{ url('surveyor/property/gated-community-details/repository/floor-files') }}">
                        <div>
                            @include('admin.pages.property.secondary_data.repositories.includes.property_info')
                        </div>
                        <div class="row old-files-icm-lable-preview-group">
        ...
        <div class="col-xxl-12 col-md-12">
            @if (isset($project_repository_files['floor_file']))
                @forelse($project_repository_files['floor_file'] as $file)
                    ...
                    @endphp
                    @if (in_array(strtolower($extension), ['pdf', 'jpg', 'jpeg', 'png', 'gif'], true))
                        <a data-fancybox="all-floor-plan" href="{{ $file }}" class="">
                            <span>
                                <img src="{{ $file }}" class="rounded-circle border border-light border-4"
                                    width="80" height="80"
                                    onerror="this.onerror=null; this.src='{{ $default_pdf_icon }}'">
                    ...
                    @else
                        <div class="card " style="width: 18rem;">
                            <video controls data-fancybox="all-floor-plan">
                                <source src="{{ asset($file) }}" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                            ...
                            <div>
                                <form class="unit-gallery-zone icm-zone">
                                    ...
                                    <input type="file" id="other_files-img" class="files img-upload"
                                        style="display: none;"
                                        data-action="{{ url('surveyor/property/gated-community-details/repository/other-files') }}">
        ...
        <div class="col-xxl-12 col-md-12">
            @if (isset($project_repository_other_files))
                @forelse($project_repository_other_files as $key=>$file)
                    ...
                    @else
                        <div class="card " style="width: 18rem;">
                            <video controls data-fancybox="other-gallery">
                                <source src="{{ asset($file) }}" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
...
@elseif($block_id == 'bt-repositories')
    @include('admin.pages.property.secondary_data.repositories.includes.block_repositories')
@endif
