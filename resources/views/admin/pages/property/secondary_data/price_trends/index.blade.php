<form method="post" name="" id="price-trends-frm">
    ...
    <div class="row border-bottom pt-3 pb-3"> <input type="hidden" name="pt_project_status"
        ...
        <div class="col-xxl-3 col-md-3 mt-3">
            <div>
                @if ($property->residential_type == 7)
                    <label for="" class="form-label ">Status of the Tower</label>
                @else
                    <label for="" class="form-label ">Status of the Unit</label>
                @endif
...
<div class="table-responsive " id="pagination_data">
    @include('admin.pages.property.secondary_data.price_trends.price_trends_paginate', [
