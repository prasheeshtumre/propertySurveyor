                    ...
                    <div class="card">
                                        ...
                                        <div class="product d-flex justify-content-center shadow-sm rounded">
                                            @foreach ($property->images->take(1) as $image)
                                                ...
                                                <a data-fancybox="gallery" class="w-100"
                                                    ...
                                                    <img @if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif'], true)) src="{{ asset('uploads/property/images/' . $image->file_url) }}"
                                                            @elseif($extension == 'pdf')
                                                                src="{{ asset('assets/images/svg/default-pdf.svg') }}" @endif
                                                            ...
                                                            @if ($key == 2)
                                                                <div class="InlinePhotoPreview--RightButtons">
                                                                    <button type="button"
                                                                        ...
                                                                        id="photo-preview-button" tabindex="0">
                                                                        <span
                                                                            class="mdi mdi-image-multiple text-dark"></span>
                                                                        <span
                                                                            class="text-dark">{{ count($property->images) }}
                                                                            photos</span>
                                                                    </button>
                                                                </div>
                                                            @endif
                                            ...
                                            @if ($ri_img_status != 0)
                                                @foreach (range(1, $ri_img_status) as $index)
                                                    <div class="col-md-12 mb-2 ri-empty-img-body">
                                                        <div
                                                            class="product d-flex justify-content-center shadow-sm rounded">
                                                            <a href="javascript:void;">
                                                                <img src="{{ asset('assets/images/svg/alt-property-img.svg') }}"
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="">
                                    <div class="">
                                        <div class="row ">
                                            @if (
                                                $property->up_for_sale == 1 ||
                                                    $property->up_for_rent == 1 ||
                                                    $property->up_for_sale_count == '1' ||
                                                    $property->up_for_rent_count == '1')
                                                <div class="d-flex mb-2 border-bottom">
                                                    ...
                                                    <span class="mx-1">
                                                        ...
                                                        @endif --}}
                                                        @if (
                                                            ($property->up_for_rent == '1' && $property->up_for_sale == '1') ||
                                                                ($property->up_for_sale_count >= '1' && $property->up_for_rent_count >= '1'))
                                                            For Sale/Rent
                                                        @elseif($property->up_for_rent == '1' || $property->up_for_rent_count >= '1')
                                                            For Rent
                                                        @elseif($property->up_for_sale == '1' || $property->up_for_sale_count >= '1')
                                                            For Sale
                                                        @else
                                                            N/A
                                                        @endif
                                            ...
                                            <div class="keyDetailsList col-md-6">
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item">
                                                        <span class="w-50">Latitude</span><strong
                                                            class="px-1 ">:</strong> {{ $property->latitude ?? '-' }}
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="w-50">Longitude</span><strong
                                                            class="px-1 ">:</strong> {{ $property->longitude ?? '-' }}
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="keyDetailsList col-md-6">
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">
                                                        <span class="w-50">Category of the property</span><strong
                                                            class="px-1">:</strong> {{ $property->category->cat_name }}
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    @foreach ($property->images as $key => $image)
                                        @if ($key >= 3)
                                            ...
                                            @if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif'], true))
                                                <a data-fancybox="gallery"
                                                    href="{{ asset('uploads/property/images/' . $image->file_url) }}">
                                                    <img src="{{ asset('uploads/property/images/' . $image->file_url) }}"
                                                        class="img-fluid">
                                                </a>
                                            @elseif($extension == 'pdf')
                                                <a data-fancybox="gallery"
                                                    href="{{ asset('uploads/property/images/' . $image->file_url) }}">
                                                    <img src="{{ asset('assets/images/svg/default-pdf.svg') }}"
                                                        class="img-fluid">
                                                </a>
                                            @endif
                                        @endif
                                ...
                                <div class="col-xxl-12 col-md-12 mt-3 mb-3">
                                    <div class="">
                                        <a class="btn btn-outline-primary me-2 p-1"
                                            href="{{ url('surveyor/property/plot-land/unit_details') }}/{{ $property->id }}">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <span class="mdi mdi-chevron-double-right mdi-18px"></span>
                                                <span class="text-dark">View Unit Details</span>
                                            </div>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <a class="badge bg-light d-flex justify-content-center"
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-center">
                                ...
                                <a class="btn btn-outline-success me-2 edit-modal-btn p-1"
                                    href="{{ route('surveyor.property.edit_details', [$property->id]) }}">
                                    <div class="d-flex justify-content-center align-items-center">
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.gis-engineer-approval', function() {
            toastr.info('this property needs approval from GIS Engineer.')
        });
        toastr.options = {
            "closeButton": true,
            "debug": false,
