                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-md-4 mt-3">
                            <div>
                                ...
                                <input type="text" name="gis_id" class="form-control" id=" " placeholder="EX: 7255158845" value="{{$property->gis_id}}" disabled>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-md-4 mt-3">
                            <div>
                                <label for="" class="form-label">Latitude</label>
                                <input type="text" name="" class="form-control" id=" " placeholder="EX: 7255158845" value="{{$property->latitude ?? ''}}" disabled>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-md-4 mt-3">
                            <div>
                                <label for="" class="form-label">Longitude</label>
                                <input type="text" name="" class="form-control" id=" " placeholder="EX: 7255158845" value="{{$property->longitude ?? ''}}" disabled>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-md-3  mt-3">
                            <label for="" class="form-label">Merge GISID</label>
                            <div class="form-check">
                                <input class="form-check-input split-merge-gis" type="radio" data-option_cnt="{{5 - count($merges)}}" value="2" name="split_merge" id="merge-gis">
                        ...
                        <div class="">
                            ...
                            <div class="split-merge-data-container ">
                                @if(count($merges) > 0)
                                <span class="badge bg-success">This Property Merged with {{implode(',', $merges)}} GIS-ID's</span>
                                @endif
                            </div>
                        ...
                        <div class="col-xxl-3 col-md-3  mt-3">
                            <div class="form-group">
                                ...
                                <select class="form-select ctfd-required" name="category" id="category">
                                    ...
                                    @else
                                    <option {{ ($property['cat_id'] == $category['id'] ? "selected":"") }} @if(!in_array($property->cat_id, $edit_allowed_categories) && $property['cat_id'] != $category['id']) disabled @endif
                        ...
                        <input type="hidden" class="" name="" id="gis_id" value="{{$property->gis_id}}">
                        ...
                        <input type="hidden" class="" name="city_id" id="city_id" value="{{ $city->pincode->pincodeCity->city->id ?? ''}}">
                        @if($floor_visible_status == false)
                        ...
                        <div class="col-xxl-3 col-md-3 mt-3">
                            <div class="form-check">
                                <input class="form-check-input p-ufs-ufr" @if($property->up_for_sale == 1) checked @endif type="checkbox" name="up_for_sale"
                                id="property_ufs">
                        ...
                        <div class="col-xxl-3 col-md-3 mt-3">
                            <div class="form-check">
                                <input class="form-check-input p-ufs-ufr" @if($property->up_for_rent == 1) checked @endif type="checkbox" name="up_for_rent"
                                id="property_ufr">
