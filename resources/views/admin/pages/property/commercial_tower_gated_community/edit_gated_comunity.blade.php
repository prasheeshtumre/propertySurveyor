                                ...
                                <div class="col-xxl-2 col-md-3 mb-3 ">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center ">
                                            ...
                                            <label for="addFloor${count}" class="form-label btn-anima btn-hover hoverfEffect "> <span><i class="fa-solid fa-cloud-arrow-up me-1"></i> Add Files</span></label>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="file" name="addFloor_n[]" id="addFloor_n${count}"
                                                class="form-control file-input"  placeholder=" "
                                                style="display:none;">
                                            <label for="addFloor_n${count}" class="form-label btn-anima btn-hover hoverfEffect "> <span> <i class="fa-solid fa-cloud-arrow-up me-1"></i> Add Files</span></label>
                                            </div>
