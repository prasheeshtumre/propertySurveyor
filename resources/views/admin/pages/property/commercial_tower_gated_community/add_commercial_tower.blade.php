...
@push('css')
    <link href="{{ asset('assets/css/commercial-tower-gated-community.css') }}?v=2345" rel="stylesheet" type="text/css" />
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Commercial Tower Details</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    ...
                    <div class="card d-none" id="add_commercial_tower_details">
                        <div class="card-body">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/property/commercialTower/repository.js') }}?v=1"></script>
    ...
    <script>
        ...
        $(document).on('click', '#btn-search-gis-id', function(e) {
            ...
            if (gis_id == '') {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('commercial-tower.get-commomercial-defined-block') }}",
                    data: {
                        gis_id: gis_id
                    },
                    success: function(response) {
                        if (response.status === false) {
                            ...
                            $('#add_commercial_tower_details').addClass('d-none');
                        } else {
                            toggleLoadingAnimation();

                            $('#defined_gis_block').html(response);
                            $('#add_commercial_tower_details').removeClass('d-none');
