         ...
         <div class="col-xxl-12 col-md-12 mb-12">
             <div>
                 ...
                 <div class="d-flex justify-content-center flex-column ">
                     ...
                     {{-- <input type="file" name="floor_plan_n[]" id="floor_plan_n" class="form-control file-input"
         ...
         <div class="col-xxl-12 col-md-12 mb-12">
             <div>
                 ...
                 <div class="d-flex justify-content-center flex-column ">
                     ...
                     {{-- <input type="file" name="image_files_n[]" id="image_files_n" class="form-control file-input"
                         multiple="" placeholder=" " style="display:none;">
         ...
         <div class="col-xxl-12 col-md-12 mb-12">
             <div>
                 ...
                 <div class="d-flex justify-content-center flex-column ">
                     ...
                     {{-- <input type="file" name="tower_video_n[]" id="tower_video_n" class="form-control file-input"
                         multiple="" placeholder=" " style="display:none;">
                         ...
                         <div class="d-flex justify-content-center ">
                             <div>
                                 ...
                                 <label for="addFloor_n" class="form-label  btn-anima btn-hover hoverfEffect ">
                                     <span><i class="fa-solid fa-cloud-arrow-up mx-2 mx-2"></i> Add Files</span>
                                 </label> --}}
                                 <form class="unit-gallery-zone icm-zone">
                                     <div class="row">
