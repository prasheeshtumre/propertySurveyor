<form class="step-1" action="{{ route('surveyor.property.update_details', [$property->id]) }}" method="post" id="create_property" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12">
            ...
            <div class="col-md-4 mb-2">
                <input type="text" placeholder="Longitude" name="longitude" id="longitude" class="form-control controls ctfd-required" value="{{ old('longitude') }}">
                @error('longitude')
                <span class="input-error" style="color: red">{{ $message }}</span>
                @enderror
            </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-md-3 mt-3">
                            <div>
                                ...
                                <input type="text" name="gis_id" class="form-control is-number" id="gis_id" placeholder="EX:7255158845" value="{{ $property->gis_id ?? '' }}" disabled>
                                @error('gis_id')
                                <span class="input-error" style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
