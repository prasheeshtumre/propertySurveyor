...
@endpush
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-3 col-md-3 mt-3">
                                            <div class="form-check">
                                                <input class="form-check-input p-ufs-ufr" type="checkbox" name="up_for_sale"
                                                    id="property_ufs">
                                        ...
                                        <div class="col-xxl-3 col-md-3 mt-3">
                                            <div class="form-check">
                                                <input class="form-check-input p-ufs-ufr" type="checkbox" name="up_for_rent"
                                                    id="property_ufr">
    ...
    <div class="modal fade" id="server-error-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        type="hidden" 
        value="0" 
        name="temp_gis_id_status"  
        id="temp-gis-id-status">
            ...
            $(document).on('click','.p-ufs-ufr', function(){
                ...
                if($(this).prop('checked') == true){
                    $('.p-ufs-ufr').each( function(){
                        // $(this).closest('.p-ufs-ufr').prop('checked', false);
