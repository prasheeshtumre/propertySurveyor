    ...
    @if ($floor_id == $unit->floor_id)
        <div class="col-md-4 mb-3 ">
            ...
            <a 
                ...
                class="active activeCard h-100 card unit-card Unit_MainDetails p-3 
                ">
                <div class="">
                    <div class="">
                            ...
                            <div class=" "style="height: 30px;">
                                <div class="position-absolute bottom-0 py-3 w-75 d-flex justify-content-between">
                                    @if ($unit->up_for_sale == 1)
                                        <img src="{{ url('public/assets/images/for-sale.png') }}" class="img-fluid"
                                            style="width: 46px;">
                                    @endif
                                    @if ($unit->up_for_rent == 1)
                                        <img src="{{ url('public/assets/images/for-rent.png') }}" class="img-fluid"
                                            style="width: 46px;">
                                    @endif
                                </div>
                            </div>
