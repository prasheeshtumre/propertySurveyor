            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Merged Property Details</h4>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('gis-engineer.property.update-details.merged', $property->id) }}" method="post"
                                >
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <label for=""><strong>GIS-ID</strong> <span> : </span>{{$property->gis_id ?? 'N/A'}}</label>
                                </div>
