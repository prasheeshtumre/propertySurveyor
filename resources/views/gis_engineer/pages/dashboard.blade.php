...
<style>
    ...
    <div class="page-content">
        <div class="container-fluid">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <a id="property-url" href="{{ route('surveyor.filter-data', 'week') }}">
                                                <p id="property-label"
                                                    class="text-uppercase fw-bold text-dark text-truncate mb-0">Surveyed This
                                                    Week
                                                </p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <a id="property-url" href="{{ route('surveyor.filter-data', 'for-sale') }}">
                                                <p id="property-label"
                                                    class="text-uppercase fw-bold text-dark text-truncate mb-0">
                                                    For Sale Properties {{ $for_sale ?? '' }}</p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <a id="property-url" href="{{ route('surveyor.filter-data', 'for-rent') }}">
                                                <p id="property-label"
                                                    class="text-uppercase fw-bold text-dark text-truncate mb-0">For Rent  Properties
                                                </p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <a id="property-url" href="{{ route('surveyor.filter-data', 'vacant') }}">
                                                <p id="property-label"
                                                    class="text-uppercase fw-bold text-dark text-truncate mb-0">Vacant  Properties
                                                </p>
                                            </a>
                                        </div>
                        ...
                        <a href="{{ route('surveyor.filter-data', 'under-construction') }}">
                            ...
                            <div class="card card-animate overflow-hidden p-2">
                                ...
                                <div class="card-body" style="background-color: #FFF4E0;">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <a id="property-url" href="{{ route('surveyor.filter-data', 'under-construction') }}">
                                                <p id="property-label"
                                                    class="text-uppercase fw-bold text-dark text-truncate mb-0">
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <a href="{{ route('surveyor.filter-data', 'splits') }}">
                        <!-- card -->
                        <div class="card card-animate overflow-hidden p-2">
                            <div class="position-absolute start-0" style="z-index: 0;">
                                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 120" width="200"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a id="property-url" href="{{ route('gis-engineer.properties', 'merged') }}">
                                            <p id="property-label"
                                                class="text-uppercase fw-bold text-dark text-truncate mb-0">Merge Properties
                                            </p>
                                        </a>
                                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <a href="{{ route('gis-engineer.filter-data', 'completed') }}">
                        <!-- card -->
                        <div class="card card-animate overflow-hidden p-2">
                            <div class="position-absolute start-0" style="z-index: 0;">
                                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 120" width="200"
                            ...
                            <div class="card-body" style="background-color: #B5F1CC;">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a id="property-url" href="{{ route('gis-engineer.properties', 'completed') }}">
                                            <p id="property-label"
                                                class="text-uppercase fw-bold text-dark text-truncate mb-0">Completed Properties
                                            </p>
                                        </a>
                                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <a href="{{ route('surveyor.filter-data', 'temporary-gis') }}">
                        <!-- card -->
                        <div class="card card-animate overflow-hidden p-2">
                            ...
                            <div class="card-body" style="background-color: #FFF4E0;">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a id="property-url" href="{{ route('gis-engineer.properties', 'temporary-gis-id') }}">
                                            <p id="property-label"
                                                class="text-uppercase fw-bold text-dark text-truncate mb-0">
                                                Update GIS IDs</p>
                                        </a>
