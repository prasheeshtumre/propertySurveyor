...
<table class="table table-striped dt-responsive table-hover nowrap data-table" style="width:100%">
        ...
        <tbody>
            @foreach ($properties as $property)
                <tr>
                    ...
                    @if ($category_type == '1')
                        <td>{{ $property->CommercialName->cat_name ?? '' }}</td>
                    @endif
                    ...
                    <td>
                        @if (
                            ($property->up_for_rent == 1 || $property->up_for_rent_count >= 1) &&
                                ($property->up_for_sale == 1 || $property->up_for_sale_count >= 1))
                            For Sale/Rent
    ...
    @elseif($category_type == '10' || $category_type == '17')
        <thead>
            <tr>
                <th>S.No</th>
                <th>Date </th>
        ...
        <tbody>
            @foreach ($properties as $property)
                <tr>
                    ...
                    <td>{{ $property->tower_units->where('no_of_towers', '!=', 0)->count() ?? 'N/A' }}</td>
                    <td>
                        @if (
                            ($property->up_for_rent == 1 || $property->up_for_rent_count >= 1) &&
                                ($property->up_for_sale == 1 || $property->up_for_sale_count >= 1))
        ...
        <tbody>
            @foreach ($properties as $property)
                <tr>
                    ...
                    <td>{{ $property->street_details ?? 'N/A' }}</td>
                    <!--<td>N/A</td>-->
                    <td>{{ $property->no_of_floors ?? ($property->storeys->count() ?? 'N/A') }}</td>
                    {{-- <td>
